    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          v-hasPermi="['agent:agentCard:add']"
          icon="el-icon-plus"
          plain
          size="mini"
          type="primary"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleReplace"
          v-hasPermi="['agent:agentCard:replace']"
        >批量换卡</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['agent:agentCard:edit']"
          :disabled="single"
          icon="el-icon-edit"
          plain
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['agent:agentCard:export']"
...
<!--      </el-table-column>-->
    ...
    >
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item label="卡密名称" label-width="80px" prop="cardName">
          <!-- <el-input v-model="form.cardName" placeholder="请输入卡密名称" /> -->
          {{ form.cardName }}
        </el-form-item>
        <el-form-item label="充值卡号" label-width="80px" prop="cardNo">
          <!-- <el-input v-model="form.cardNo" placeholder="请输入卡号" /> -->
          {{ form.cardNo }}
        </el-form-item>
        <el-form-item label="充值密码" label-width="80px" prop="cardPass">
...
<script>
import {addCard, delCard, exportCard, getCard, listCard, listCardTemplateAll, updateCard, getBatchNoList, batchReplace} from "@/api/agent/agentCard";
