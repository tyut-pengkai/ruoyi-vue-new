<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="单码类别" prop="cardName">
<!--        <el-input-->
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleReplace"
          v-hasPermi="['system:loginCode:replace']"
        >批量换卡</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['system:loginCode:import']"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item label="单码名称" label-width="80px" prop="cardName">
          <el-input v-model="form.cardName" placeholder="请输入单码名称" maxlength="50" show-word-limit :disabled="form.isCharged === 'Y'"/>
        </el-form-item>
        <el-form-item label="单码内容" label-width="80px" prop="cardNo">
          <el-input v-model="form.cardNo" placeholder="请输入单码" maxlength="100" show-word-limit :disabled="form.isCharged === 'Y'"/>
        </el-form-item>
        <el-form-item prop="">
          <el-col :span="12">
            <el-form-item label="单码状态" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/loginCode/importData",
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
  ...
  created() {
    ...
    listLoginCodeTemplateAll({}).then((response) => {
  ...
  methods: {
    ...
    /** 导入按钮操作 */
    handleImport() {
      this.upload.title = "单码导入";
      this.upload.open = true;
    },
    /** 下载模板操作 */
    importTemplate() {
      this.download(
        "system/loginCode/importTemplate",
        {},
        `login_code_template_${new Date().getTime()}.xlsx`
      );
    },
    // 文件上传中处理
