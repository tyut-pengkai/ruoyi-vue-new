...
/**
 * 上架任务对象 wms_shelf_task
 *
 * @author zhanglei
 * @date 2023-04-12
 */
@Alias("ShelfTask")
public class ShelfTask extends BaseEntity {
    ...
    private String isQc;
    /** 收货单号 **/
    private String  delivery0rderNo;

    public String getDelivery0rderNo() {
        return delivery0rderNo;
    }

    public void setDelivery0rderNo(String delivery0rderNo) {
        this.delivery0rderNo = delivery0rderNo;
    }
