...
import com.ruoyi.framework.license.LicenseManagerHolder;
...
//            e.printStackTrace();
    ...
    private LicenseParam initLicenseParam(LicenseVerifyParam param) {
        Preferences preferences = Preferences.userNodeForPackage(HyV.class);

        CipherParam cipherParam = new DefaultCipherParam(param.getStorePass());

        KeyStoreParam publicStoreParam = new CustomKeyStoreParam(HyV.class
