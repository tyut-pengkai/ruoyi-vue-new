...
<img alt="image" src="@source/install/windows/bt/1.jpg">
<img alt="image" src="@source/install/windows/bt/2.jpg">
安装完毕后点击面板右侧<code v-pre>一键开启</code>启动所有服务
<img alt="image" src="@source/install/windows/bt/3.jpg"></p>
...
<img alt="image" src="@source/install/windows/bt/4.jpg">
<img alt="image" src="@source/install/windows/bt/5.jpg"></p>
...
<p><img alt="image" src="@source/install/windows/bt/6.jpg"></p>
<h5 id="_2、解压程序压缩包" tabindex="-1"><a aria-hidden="true" class="header-anchor" href="#_2、解压程序压缩包">#</a> 2、解压程序压缩包</h5>
<p>解压下载的红叶验证程序压缩包，如图：
<img alt="image" src="@source/install/windows/bt/7.jpg">
...
<p>如果出现以下提示代表启动成功
<img alt="image" src="@source/install/windows/bt/8.jpg"></p>
<blockquote>
...
<img alt="image" src="@source/install/windows/bt/9.jpg"></p>
<p>域名：填写您自己的域名，此处以<code v-pre>hy.coordsoft.com</code>为例
网站路径：选择上传的程序包中的<code v-pre>web</code>目录
PHP版本：无需选择</p>
<p><img alt="image" src="@source/install/windows/bt/10.jpg"></p>
<p>创建完毕后点击<code v-pre>编辑虚拟主机</code>，选择<code v-pre>配置文件</code></p>
<p><img alt="image" src="@source/install/windows/bt/11.jpg"></p>
