...
:::tip 不会使用某个功能时可以将鼠标悬浮在对应功能标题后的?获取帮助  
项目名称前带`*`的表示该项为必填项  
:::
...
:::tip 提示：如果需要更新版本时请新建一个版本，并设置一个更大的版本号即可，而不要修改或删除已有的版本，如果版本被删除，那么对应版本的软件将无法使用。  
:::
...
- 单例模式：单例模式为半自动注入模式，需指定要注入的Activity和Method。  
  :::tip
  <a href='/guide/qa/qa.html#%E5%8D%95%E4%BE%8B%E6%B3%A8%E5%85%A5%E7%9A%84activity%E5%92%8Cmethod%E5%BA%94%E8%AF%A5%E5%A6%82%E4%BD%95%E9%80%89%E6%8B%A9'>
  点此查看Activity和Method该如何选择</a>
  :::  
  **接入类别**：
