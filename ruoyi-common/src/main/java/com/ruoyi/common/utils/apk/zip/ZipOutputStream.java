...
import com.ruoyi.common.utils.apk.zip.encoding.ZipEncoding;
import com.ruoyi.common.utils.apk.zip.encoding.ZipEncodingHelper;
import com.ruoyi.common.utils.apk.zip.extrafield.UnicodeCommentExtraField;
import com.ruoyi.common.utils.apk.zip.extrafield.UnicodePathExtraField;
...
import static com.ruoyi.common.utils.apk.zip.ZipShort.putShort;
import static com.ruoyi.common.utils.apk.zip.encoding.ZipEncodingHelper.UTF8_ZIP_ENCODING;
...
public class ZipOutputStream extends FilterOutputStream {
    ...
    public void closeEntry() throws IOException {
        ...
        if (currentIsRawEntry)
            ...
            if (raf != null) {
                ...
                ZipLong.putLong(entry.getCrc(), data, 0);
                ZipLong.putLong(entry.getCompressedSize(), data, 4);
                ZipLong.putLong(entry.getSize(), data, 8);
                writeOut(data);
                raf.seek(save);
            }
        }
    ...
    protected void writeLocalFileHeader(ZipEntry ze) throws IOException {
        ...
        ZipLong.putLong(toDosTime(ze.getTime()), data, 10);
        written += WORD;
...
//        }
    ...
    protected void writeDataDescriptor(ZipEntry ze) throws IOException {
        ...
        ZipLong.putLong(entry.getCrc(), data, 4);
        ZipLong.putLong(entry.getCompressedSize(), data, 8);
        ZipLong.putLong(entry.getSize(), data, 12);
        writeOut(data);
        // CheckStyle:MagicNumber OFF
        written += 16;
        // CheckStyle:MagicNumber ON
...
//    private static final byte[] DOS_TIME_MIN = ZipLong.getBytes(0x00002100L);
    ...
    protected void writeCentralFileHeader(ZipEntry ze) throws IOException {
        ...
        // last mod. time and date
        ZipLong.putLong(toDosTime(ze.getTime()), data, 12);
        written += WORD;
        ...
        ZipLong.putLong(offsets.get(ze), data, 42);
        written += WORD;
...
//        putBytes(ZERO, buf, 6);
        ...
        ZipLong.putLong(cdLength, buf, 12);
        ZipLong.putLong(cdOffset, buf, 16);
