...
public class AppUserInfoNc extends Function {
    ...
    @Override
    public void init() {
        this.setApi(new Api("appUserInfo.nc", "获取用户信息", false, Constants.API_TAG_CODE,
                "获取用户信息", new AuthType[]{AuthType.LOGIN_CODE}, Constants.BILL_TYPE_ALL, new Param[]{
