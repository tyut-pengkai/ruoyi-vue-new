...
public interface ISysDictTypeService {
     ...
     * @return 结果
     */
    boolean checkDictTypeUnique(DictTypeDTO typeDTO);
     ...
     * @return Integer
     */
    Integer create(DictTypeDTO typeDTO);
     ...
     */
    Page<DictTypePageResVO> page(DictTypePageDTO pageDTO);
     ...
     * @return
     */
    Integer update(DictTypeDTO typeDTO);
     ...
     */
    DictTypeResDTO selectById(Long dictId);
