...
INSERT INTO `advert` VALUES (65, 2, 'hahWvpAsj4', 10, 1, 401, 4, 1, 2, 150.00, 3, 4, '22:00:00', 10, NULL, '', '', NULL, NULL, NULL, NULL, NULL, 2, '0', '', '2025-08-13 23:15:50', '', '2025-12-04 11:29:55');
...
values (1, 'cdbuju@0115', '超级管理员', '00', 'ry@163.com', '15888888888', '1', '',
        '$2a$10$5PGlouNhW9CbBDGsUuO2E.RjGBXdd1L8asKmlGz.4FDRS.OBXoC2m', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员', 0);
...
INSERT INTO `sys_menu` VALUES (1030, '需求表格模板', 1027, 3, '', '', '', '', 1, 1, 'C', '0', '0', '', '', 'admin', '2025-07-15 16:07:34', 'admin', '2025-07-15 16:07:34', '', '0', 0);
...
INSERT INTO `sys_job` VALUES (133, '自动完成待发货订单', 'DEFAULT', 'xktTask.autoCompletePendingShipmentStoreOrder', '0 0/10 * * * ? ', '3', '1', '0', 0, '0', 'admin', '2025-09-02 16:08:01', '', '2025-09-02 16:08:01', '');
...
(
    ...
    `select_shaft_material`             tinyint(3) UNSIGNED NULL DEFAULT NULL COMMENT '面料材质',
