...
@Slf4j
public class AlipaySandboxPayment extends Payment {
...
//            notifyUrl = "http://1508qs4589.zicp.vip";
            ...
            signType = "RSA2";
            notifyUrl += pathMapping + "/sale/shop/notify/alipay_qr_sandbox";
        }
        this.setCode("alipay_qr_sandbox");
        this.setName("支付宝QR沙箱");
