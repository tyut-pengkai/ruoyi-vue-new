...
public class AsyncFactory
{
     ...
     * @return 任务task
     */
    public static TimerTask recordAppLogininfor(final Long appUserId, final String userName, final String appName, final String appVersion, final String deviceCode, final String status, final String message,
                                                final Object... args) {
        final UserAgent userAgent = UserAgent.parseUserAgentString(ServletUtils.getRequest().getHeader("User-Agent"));
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                s.append(LogUtils.getBlock(ip));
                s.append(address);
                s.append(LogUtils.getBlock(appUserId));
                s.append(LogUtils.getBlock(userName));
                ...
                String browser = userAgent.getBrowser().getName();
                // 封装对象
                SysAppLogininfor logininfor = new SysAppLogininfor();
                logininfor.setAppUserId(appUserId);
                logininfor.setUserName(userName);
