...
//        try {
//            // 读入原文件
//            String oriPath = PathUtils.getUserPath() + File.separator + "src/test/resources" + File.separator + "美杜莎辅助源码.apk";
...
//            } else {
//                String targetDexName = "classes" + dexNameList.size() + ".dex";
//                // 分析dex
...
//                editConfig(injectConfigActivityClassDef, oriBuilder);
//
...
//    }
//
//    private void editConfig(DexBackedClassDef def, DexBuilder builder) throws Exception {
...
//    }
//
//    private String getClassDefString(DexBackedClassDef def) throws IOException {
