...
public class StoreCertStepResDTO {

    @ApiModelProperty(value = "档口认证信息")
    private SCSStoreCertDTO storeCert;
    @ApiModelProperty(value = "档口基础信息")
    private SCSStoreBasicDTO storeBasic;

    @Data
    @ApiModel
    public static class SCSStoreBasicDTO {
    ...
    @Data
    public static class SCSStoreCertDTO {
