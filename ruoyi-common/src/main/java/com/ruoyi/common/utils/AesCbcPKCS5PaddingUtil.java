...
public class AesCbcPKCS5PaddingUtil {
    ...
    public static String encode(byte[] data, String aesKey) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
        if (aesKey == null) {
            return null;
        }
        if (aesKey.getBytes(UTF_8).length != AES_KEY_LENGTH) {
