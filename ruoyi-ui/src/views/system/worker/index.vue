<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="workerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="技术人员姓名" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="技术人员姓名" prop="name">
          <el-input v-model="form.name" placeholder="请输入技术人员姓名" />
        </el-form-item>
        <el-form-item label="工种" prop="workType">
...
<script>
import { listWorker, getWorker, delWorker, addWorker, updateWorker } from "@/api/system/worker";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除技术人员管理编号为"' + ids + '"的数据项？').then(function() {
