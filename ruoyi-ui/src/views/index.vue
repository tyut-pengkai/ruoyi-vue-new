            ...
            <el-collapse accordion>
              <el-collapse-item title="v0.0.7 - 2022-08-06">
                <ol>
                  ...
                  <li>修复：修复软件最新版本API和软件最新强制版本API接口当版本停用时依然提示更新的问题</li>
                  <li>修复：修复在线用户单码用户搜索不生效的问题（感谢@手游大咖）</li>
                  <li>修复：修复仪表盘统计信息中今日激活充值卡/单码统计数据错误的问题（感谢@手游大咖）</li>
                  <li>修复：修复仪表盘统计信息当充值卡/单码数据量过大时请求超时的问题</li>
                  <li>新增：安卓程序(apk)快速接入功能，支持自动签名，目前只支持[单码计时]模式</li>
                  <li>新增：软件试用功能，支持按时间段或次数多种方式配置试用规则，同步增加试用登录API接口</li>
                  <li>新增：增加代理批量制卡回显，支持复制和下载</li>
                  <li>优化：简化安装步骤，去除logback.xml配置文件</li>
                  <li>优化：用户账号/软件用户/用户设备/用户单码被冻结/过期后将立刻作用于API接口，用户将立刻下线（旧版本需等用户自行下线或后台踢掉）</li>
                  <li>优化：优化客户端下线相关提示（系统强制下线/账号异地登录等）</li>
                  <li>优化：用户/卡密登录API接口增加"autoReducePoint"参数，用于指定计点模式下是否登录成功后自动扣除用户点数（扣除1），默认值为true</li>
                </ol>
              </el-collapse-item>
