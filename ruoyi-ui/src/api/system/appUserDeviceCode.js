...
export function listAppUserDeviceCode(query) {
  return request({
    url: '/system/appUserDeviceCode/list',
    method: 'get',
    params: query
  })
}
...
export function getAppUserDeviceCode(id) {
  return request({
    url: '/system/appUserDeviceCode/' + id,
    method: 'get'
  })
}
...
export function exportAppUserDeviceCode(query) {
  return request({
    url: '/system/appUserDeviceCode/export',
    method: 'get',
    params: query
  })
}
...
export function changeAppUserDeviceCodeStatus(id, status) {
  ...
  return request({
    url: '/system/appUserDeviceCode/changeStatus',
    method: 'put',
    data: data
  })
}
