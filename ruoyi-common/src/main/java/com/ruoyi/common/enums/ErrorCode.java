...
public enum ErrorCode {
    ...
    ERROR_LOGIN_CODE_NOT_EXIST(400090005, "单码不存在"),
    ERROR_LOGIN_CODE_LOCKED(400090006, "单码被冻结"),
    ERROR_LOGIN_CODE_EXPIRED(400090007, "单码已过期"),
    ERROR_LOGIN_CODE_APP_MISMATCH(400090008, "单码与软件不匹配"),
