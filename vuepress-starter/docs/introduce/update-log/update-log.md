...
优化：新增授权时显示卡类零售价格  
:::tip 注意：本版本升级需要调整一下application-config.yml文件，文件中主库数据源的url配置需要在原有配置后新增【&allowMultiQueries=true】  
如原url值为【url: jdbc:mysql://127.0.0.1:
3306/hywlyz?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull
